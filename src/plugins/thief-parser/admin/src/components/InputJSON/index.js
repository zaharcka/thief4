...
class InputJSON extends React.Component {
  ...
  componentDidMount() {
    console.log("DID MOUNT JSON INPUT");
  ...
  setInitValue = () => {
    console.log("setInitValue JSON INPUT");
    const { value } = this.props;

    try {
      console.log("setInitValue JSON INPUT 2, value>>>>", value);
      if (value === null) return this.codeMirror.setValue("");
      console.log("setInitValue JSON INPUT 3");
      return this.codeMirror.setValue(value);
    } catch (err) {
      console.log("setInitValue JSON INPUT 4");
